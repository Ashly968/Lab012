from Planets_in_space.gravity import UniversalGravity as U
from Planets_in_space.sun import Sun
from Planets_in_space.planets import Planet
import math
...
class SolarSystem:
    ...
    def add_planets(self, new_planet: Planet):
    ...
    def move_planets(self):
        ...
        for planet in self.planets:
            ...
            # After we need to calculate the new distance from the sun using the distance formula.
